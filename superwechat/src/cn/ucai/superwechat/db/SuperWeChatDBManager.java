        ...
        if (db.isOpen()) {
            ...
            for (User user : contactList) {
                ...
                if (user.getMAvatarLastUpdateTime() != null)
                    values.put(UserDao.USER_COLUMN_NAME_AVATAR_UPDATE_TIEM, user.getMAvatarLastUpdateTime());
    ...
    synchronized public Map<String, User> getAppContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                user.setMAvatarLastUpdateTime(cursor.getString(cursor.getColumnIndex(UserDao.USER_COLUMN_NAME_AVATAR_UPDATE_TIEM)));
